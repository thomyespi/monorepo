...
export function WhatsAppButton() {
    ...
    return (
        <M tag="a" mobile={isMobile}
            ...
            className="fixed bottom-10 right-10 z-100 w-16 h-16 bg-primary text-white rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(26,54,93,0.4)] md:w-20 md:h-20 hover:scale-110 active:scale-90 transition-transform"
        >
            <svg viewBox="0 0 24 24" className="w-8 h-8 md:w-10 md:h-10 fill-white" xmlns="http://www.w3.org/2000/svg">
